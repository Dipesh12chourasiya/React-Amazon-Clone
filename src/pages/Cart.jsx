      ...
      {products.length > 0 ? (
                    ...
                    <div className="w-full flex items-center gap-6">
                      ...
                      <div className="w-4/5">
                        ...
                        <div className="bg-[#F0F2F2] flex justify-center items-center gap-1 w-24 py-1 text-center drop-shadow-lg rounded-md">
                          ...
                          <p
                            onClick={() =>
                              dispatch(deccrementQuantity(item.id))
                            }
        ...
        className="flex justify-center items-center gap-4 py-10">
          ...
          <div className="w-96 p-4 bg-white flex flex-col items-center rounded-md shadow-lg">
            <h1 className="font-titleFont">Your Cart feels lonely.</h1>
            <p className="text-sm text-center font-bodyFont">
